...
public sealed class FetchLambdaFunctionTests
{
    ...
    private sealed class TestLambdaContext(TimeSpan remainingTime) : ILambdaContext
    {
        ...
        public string FunctionName => "TecFuelMix.FetchLambda";
        public string FunctionVersion => "1";
        public ICognitoIdentity Identity => throw new NotSupportedException();
        public string InvokedFunctionArn => "arn:aws:lambda:us-east-1:123:function:TecFuelMix.FetchLambda";
        public ILambdaLogger Logger { get; } = new TestLambdaLogger();
        public string LogGroupName => "/aws/lambda/TecFuelMix.FetchLambda";
